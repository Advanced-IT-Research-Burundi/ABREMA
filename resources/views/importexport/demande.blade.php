               ...
               <!-- SIDEBAR NAV -->
                ...
                <main class="main-content">
                    ...
                    <div class="page-section">
                        ...
                        <div class="mt-4">
                            <a href="{{ asset('files/2025040709010267f3944edf211.pdf') }}" target="_blank" class="btn btn-outline-primary" style="padding: 10px 20px; border-radius: 8px; text-decoration: none; border: 1px solid #007bff; color: #007bff; display: inline-flex; align-items: center; gap: 8px; font-weight: 600;">
                                <i class="fas fa-eye"></i> Consulter la Note
                            </a>
                            <a href="{{ asset('files/2025040709010267f3944edf211.pdf') }}" download class="btn btn-outline-success" style="padding: 10px 20px; border-radius: 8px; margin-left: 10px; text-decoration: none; border: 1px solid #28a745; color: #28a745; display: inline-flex; align-items: center; gap: 8px; font-weight: 600;">
                                <i class="fas fa-download"></i> Télécharger
                            </a>
                            <button onclick="copyToClipboard('{{ asset('files/2025040709010267f3944edf211.pdf') }}', this)" class="btn btn-outline-info" style="padding: 10px 20px; border-radius: 8px; margin-left: 10px; text-decoration: none; border: 1px solid #17a2b8; color: #17a2b8; display: inline-flex; align-items: center; gap: 8px; font-weight: 600; background: transparent;">
