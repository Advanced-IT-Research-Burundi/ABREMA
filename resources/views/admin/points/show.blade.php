            ...
            <div class="card point-header-card">
                @if ($pointEntree->image)
                    <div class="point-hero-image">
                        <img src="{{ Storage::url($pointEntree->image) }}" alt="{{ $pointEntree->nom }}">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="image-actions mt-3">
                            <a href="{{ Storage::url($pointEntree->image) }}" class="btn btn-success"
                                download="{{ $pointEntree->nom }}.jpg">
                                <i class="fas fa-download"></i>
                                Télécharger l'image
                            </a>
                            <a href="{{ Storage::url($pointEntree->image) }}" class="btn btn-info" target="_blank">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="quick-actions">
                        <a href="{{ route('admin.point-entrees.edit', $pointEntree) }}" class="action-card action-edit">
                        ...
                        @if ($pointEntree->image)
                            <a href="{{ Storage::url($pointEntree->image) }}" download="{{ $pointEntree->nom }}.jpg"
                        ...
                        <form action="{{ route('admin.point-entrees.destroy', $pointEntree) }}" method="POST"
