                    ...
                    @foreach ($pointEntrees as $point)
                        <div class="point-card">
                            <div class="point-image-container">
                                @if ($point->image)
                                    <img src="{{ Storage::url($point->image) }}" alt="{{ $point->nom }}"
                                        class="point-image">
                                @else
                            ...
                            <div class="point-actions">
                                <a href="{{ route('admin.point-entrees.show', $point) }}" class="btn btn-sm btn-info"
                                    title="Voir">
                                    <i class="fas fa-eye"></i>
                                </a>
                                <a href="{{ route('admin.point-entrees.edit', $point) }}" class="btn btn-sm btn-warning"
                                    title="Modifier">
                                    <i class="fas fa-edit"></i>
                                </a>
                                <form action="{{ route('admin.point-entrees.destroy', $point) }}" method="POST"
                                    class="d-inline"
