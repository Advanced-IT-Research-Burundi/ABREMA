...
<div class="max-w-4xl mx-auto">
    ...
    <nav class="mb-6">
        <ol class="flex items-center space-x-2 text-sm text-gray-600">
            ...
            <li><a href="{{ route('admin.textes.index') }}" class="hover:text-green-600">Textes Réglementaires</a></li>
            <li><i class="fas fa-chevron-right text-xs"></i></li>
    ...
    <div class="bg-white rounded-lg shadow-sm">
        ...
        <form action="{{ route('admin.textes.store') }}" method="POST" enctype="multipart/form-data" class="p-6 space-y-6">
            @csrf
            ...
            <div class="flex items-center justify-end space-x-4 pt-6 border-t border-gray-200">
                <a href="{{ route('admin.textes.index') }}" class="px-6 py-2 border border-gray-300 text-gray-700 rounded-lg hover:bg-gray-50 transition">
                    Annuler
                </a>
