...
<div class="max-w-4xl mx-auto">
    ...
    <div class="bg-white rounded-lg shadow-sm">
        <div class="p-6 border-b border-gray-200">
            <h2 class="text-xl font-bold text-gray-800">Modifier le Client</h2>
            <p class="text-gray-600 mt-1">Modifiez les informations de ce client</p>
        </div>

        <form action="{{ route('admin.clients.update', $client) }}" method="POST" enctype="multipart/form-data" class="p-6 space-y-6">
            @csrf
            @method('PUT')
            ...
            {{-- <div>
                ...
                <!-- Preview -->
                <div id="imagePreview" class="mt-4 {{ $client->image ? '' : 'hidden' }}">
                    <div class="relative">
