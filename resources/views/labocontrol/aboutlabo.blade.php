...
@section('content')
    <div class="container">
        <h3><strong>A propos de labo ABREMA</strong></h3>
        <ul>
            <li><strong>Objectif du laboratoire de contrôle qualité</strong> </li>
        </ul>
    </div>
    <div>
        <p> La direction des services de laboratoire est l’une des directions techniques de l’ABREMA.
        ...
        <h3>Les objectifs du laboratoire de contrôle qualité sont </h3>
        <ul>
            <li>Conduire une évaluation de la qualité des médicaments et autres produits règlementés
                à travers les analyses au laboratoire, tout en produisant des rapports exacts et précis
                en temps opportun.
            </li>
            <li>
                Effectuer des vérifications sur terrain de produits réglementés au moyen de techniques de
                screening comme la spectrométrie (NIR), la spectrométrie Raman et les techniques sur la CCM.
            </li>
            <li>
                Produire des preuves scientifiques et des rapports sur la qualité et l’innocuité des produits
                réglementés afin d’éclairer et de faciliter la prise de décisions réglementaires.
            </li>
            <li>
                Fournir un soutien technique aux fabricants locaux et renforcer leurs capacités en matière de contrôle
        ...
        <h3><strong>Missions du laboratoire</strong></h3>
        <p>Les missions du laboratoire de contrôle qualité peuvent être divisées en deux groupes :</p>
        <ol>
            <li>Mission d'ordre public ;</li>
            <li>Aider l’Autorité de régulation dans sa mission de surveillance de la qualité des produits
                règlementés, après commercialisation en vérifiant que les produits importés ou fabriqués
                localement sont de bonne qualité ou sont restés stables dans les conditions de stockage tout
                au long de la chaine d’approvisionnement et dans différents stocks, en examinant les produits
            ...
            <li>
                Contribuer dans la prise de décision lors de l’évaluation des dossiers de demande d’Autorisation
                de Mise sur le Marche (AMM) des produits règlementés déposé à l’Autorité de régulation par le contrôle
        ...
        <h3><strong>Mission de prestation de service</strong></h3>
        <p>Faciliter le contrôle qualité de tous les produits règlementés importés ou fabriqués localement
            (contrôle qualité de routine) pour s’assurer que ces produits sont conformes aux normes de qualités
            requises et si le conditionnement est adéquat pour garder l’intégrité du produit.
        </p>
    </div>
@endsection
