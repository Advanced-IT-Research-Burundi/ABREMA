...
@section('title', 'SerciveLaboratoire')
            ...
            <div class="layout-row">
                ...
                <main class="main-content">
                    ...
                    <div class="page-section">
                        ...
                        <p class="page-text">
                            C’est dans cette optique que l’ABREMA a été mis en place comme une agence de régulation des
                            produits
                            réglementés comportant une Direction des services de laboratoire et de régulation de contrôle de
                            la
                            qualité des aliments.
                        </p>

                        <p class="page-text">
                            Cette Direction est chargée de contrôler l’application des normes de qualité, superviser et
                            coordonner
                            les activités de contrôle de qualité des médicaments à usage humain, des médicaments
                            traditionnels, des
                            produits cosmétiques et diététiques contenant un principe actif ; réglementer toutes les
                            activités relatives
                            à la qualité et l’innocuité des aliments préfabriqués et emballés sur toute la chaîne depuis la
                            production
