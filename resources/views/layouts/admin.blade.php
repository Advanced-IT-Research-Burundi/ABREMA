    ...
    <aside
        ...
        <nav class="flex-1 py-4 overflow-y-auto">
            <div class="px-4 space-y-1">
                ...
                <!--Formulaire d' Inspections -->

                <a href="{{ route('admin.formulaire-inspection.index') }}"
                    class="flex items-center px-4 py-3 text-gray-700 rounded-lg hover:bg-green-50 hover:text-green-700 transition {{ request()->routeIs('admin.formulaire-inspection.*') ? 'bg-green-50 text-green-700' : '' }}">
                    <i class="w-5 fas fa-box"></i>
                    <span class="ml-3 font-medium">Formulaire d' Inspections</span>
