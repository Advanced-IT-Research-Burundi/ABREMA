...
<head>
    ...
    <meta name="description"
        content="Autorité Burundaise de Régulation des Médicaments à usage humain et des Aliments - ABREMA">
            ...
            <div class="container-2">
                <div class="contact-info">
                    ...
                    <span><i class="fas fa-envelope"></i> <a
                            href="mailto:info@abrema.gov.bi">info@abrema.gov.bi</a></span>
                </div>
                <div class="social-links">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="has-submenu">
                                    ...
                                    <ul class="dropdown-menu-secondary">
                                        ...
                                        <li><a href="{{ route('medicament.notification') }}">Listes des
                                                Notifications</a></li>
                                        <li><a href="{{ route('medicament.textemedicament') }}">Textes
                                                Réglementaires</a></li>
                                    </ul>
                                </li>
                                ...
                                <li class="has-submenu">
                                    ...
                                    <ul class="dropdown-menu-secondary">
                                        <li><a href="{{ route('importexport.demande') }}">Demande d'importation</a>
                                        </li>
                                        <li><a href="{{ route('importexport.texteimport') }}">Textes Réglementaires</a>
                                        </li>
                                        <li><a href="{{ route('importexort.pointentree') }}">Les points d’entrée</a>
                                        </li>
                                    </ul>
                                </li>
                                ...
                                <li class="has-submenu">
                                    ...
                                    <ul class="dropdown-menu-secondary">
                                        <li><a href="{{ route('vigilance.notificationES') }}">Notifications / ES</a>
                                        </li>
                ...
                <div class="footer-grid">
                    ...
                    <div class="footer-col">
                        ...
                        <ul class="footer-links">
                            ...
                            <li><a href="https://www.minsante.gov.bi/">Ministre de la Santé Publique et de la Lutte
                                    contre le Sida</a></li>
                            <li><a href="https://finances.gov.bi/">Ministère des Finances , du Budget et de la
                                    Planification Economique</a></li>
